...
Name = "EWW_holdings_"+FECHAHOY+".csv"
...
Path = "Bases\\ "
#Which name it will have
Name = "EEM_holdings_"+FECHAHOY+".csv"
#The names of the columns
col_names=['Ticker','Name','Asset Class','Weight (%)','Price','Shares','Market Value',
           'Notional Value','Sector','SEDOL','ISIN','Exchange','Location','Currency',
           'Market Currency','FX Rate']
...
Path = "Bases\\ "
#Which name it will have
Name = "ACWI_holdings_"+FECHAHOY+".csv"
#The names of the columns
col_names=['Ticker','Name','Asset Class','Weight (%)','Price','Shares','Market Value',
           'Notional Value','Sector','SEDOL','ISIN','Exchange','Location','Currency',
           'Market Currency','FX Rate']
...
Path = "Bases\\ "
#Which name it will have
Name = "IVV_holdings_"+FECHAHOY+".csv"
#The names of the columns
col_names=['Ticker','Name','Asset Class','Weight (%)','Price','Shares','Market Value',
           'Notional Value','Sector','SEDOL','ISIN','Exchange','Location','Currency',
           'Market Currency','FX Rate']
...
Path = "Bases\\ "
#Which name it will have
Name = "INDA_holdings_"+FECHAHOY+".csv"
#The names of the columns
col_names=['Ticker','Name','Asset Class','Weight (%)','Price','Shares','Market Value',
           'Notional Value','Sector','SEDOL','ISIN','Exchange','Location','Currency',
           'Market Currency','FX Rate']
